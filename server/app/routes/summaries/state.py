...
async def fetch_state_legislators(state_abbr: str):
    ...
    async with httpx.AsyncClient() as client:
        ...
        chambers = ["upper", "lower"] # "upper" = senate, "lower" = house
    ...
    return summarize_state_legislators(members[0], members[1])


def summarize_state_legislators(senate_members, house_members):
...
@router.get("/{state_abbr}/legislative")
